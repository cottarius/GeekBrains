...
<?php
    $workExperience = [
        [
            ...
            'endDate' => '25.08.2005',
            'description' => 'работал сантехником в Водоканале'
        ],
        [
            'name' => 'Каменьщик',
            'startDate' => '26.08.2005',
            'endDate' => '25.05.2009',
            'description' => 'работал каменьщиком в ДРСУ-5'
        ],
        [
            'name' => 'Плотник',
            'startDate' => '26.05.2009',
            'endDate' => '02.11.2015',
            'description' => 'работал плотником в ДРСУ-6'
        ],
        [
            'name' => 'Программист',
            'startDate' => '03.11.2009',
            'endDate' => '12.10.2023',
            'description' => 'работаю программистом в IT-компании'
        ],
    ];
?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workExperience[$i]['startDate']?> - <span class="w3-tag w3-teal w3-round"><?php echo $workExperience[$i]['endDate']?></span></h6>
